    ...
    <div className="animate-fade-in">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
          <div>
            ...
            <p className="page-subtitle">{isAdmin ? "Manage leave applications" : "Your leave requests and history"}</p>
          </div>
          {!isAdmin && !isDeleted && (
          ...
          {leaveStats.map((s)=>{
            ...
            <div key={s.label} className="card card-hover p-5 sm:p-6 flex items-center gap-4 relative overflow-hidden group">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-slate-900 tracking-tight">{s.value}<span className="text-sm font-normal text-slate-400 m-2">taken</span></p>
              </div>   
            </div>
            )  
          })}
