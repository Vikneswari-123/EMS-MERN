  ...
  return (
    <div className="animate-fade-in">
        ...
        items-start sm:items-center gap-4 mb-8">
          ...
          <button onClick={()=>setShowCreateModal(true)} className="btn-primary cursor-pointer flex items-center gap-2 w-full sm:w-auto justify-center">
    ...
    {showCreateModal && (
      <div className="fixed bg-black/40 backdrop-blur-sm inset-0 z-50 flex items-start justify-center
      p-4 overflow-y-auto" onClick={()=>setShowCreateModal(false)}>
