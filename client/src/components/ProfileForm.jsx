...
const ProfileForm = ({initialData, onSuccess}) => {
  ...
  return (
    <form onSubmit={handleSubmit} className='card p-5 sm:p-6 mb-6'>
        ...
        {message && (
            <div className='bg-emarald-50 text-emerald-700 p-4 rounded-xl text-sm border border-emerald-200 mb-6 flex items-start gap-3'>
        ...
        <div className='space-y-5'>
            ...
            {initialData.isDeleted ? (
                ...
                <div className='flex justify-end pt-2'>
                    <button type='submit' disabled={loading} className='btn-primary flex items-center gap-2 jusify-center w-full sm:w-auto'>
